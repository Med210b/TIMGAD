      ...
      <section className="relative h-[60vh] min-h-[400px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full pb-12">
          <div className="container mx-auto px-4 md:px-6">
            <Link 
              to="/blogs" 
              className="text-gold text-xs font-bold tracking-[0.2em] flex items-center mb-8 hover:translate-x-[-4px] transition-transform w-fit uppercase"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8">
              ...
              >
                ...
                {/* Blog Intro / Excerpt */}
                <p className="text-xl text-[#233d00] leading-relaxed font-medium mb-10 italic border-l-4 border-gold pl-8">
                  {blog.excerpt}
                </p>
                ...
                <div className="text-[#233d00] [&>p]:text-[#233d00] text-lg leading-relaxed space-y-8 font-light">
                  ...
                  <h3 className="text-2xl font-black text-dark-text uppercase tracking-wider mt-12 mb-6">
                  ...
                  <div className="bg-white p-10 rounded-2xl border border-black/5 my-12 shadow-xl">
                    <h4 className="text-gold font-bold mb-4 uppercase tracking-widest text-sm">
                      Key Takeaways:
                    </h4>

                    <ul className="space-y-4">
                      {[
                        'Early preparation for renewals avoids penalties.',
                        'Proper documentation is the foundation of transparency.',
                        'Consulting experts ensures alignment with the latest decrees.',
                        'Digital transformation is streamlining government interactions.'
                      ].map((point, i) => (
                        <li key={i} className="flex items-start space-x-4">
                          <div className="w-1.5 h-1.5 bg-gold rounded-full mt-2 shrink-0" />
                          <span className="text-[#233d00]">
                            {point}
                          </span>
                        </li>
                      ))}
            ...
            <div className="lg:col-span-4 space-y-12">
              ...
              <div className="glass-card p-10 bg-primary-bg border-gold/10">
                <h3 className="text-white font-bold text-sm mb-8 uppercase tracking-widest">
                  Related Articles
                </h3>
                ...
                <div className="space-y-8">
                  {BLOGS.filter(b => b.id !== blog.id).map(related => (
                    ...
                    >
                      ...
                      <h4 className="text-white font-bold text-sm group-hover:text-gold transition-colors leading-tight uppercase">
                        {related.title}
                      </h4>
                    </Link>
                  ))}
              ...
              <div className="glass-card p-10 border-gold shadow-2xl shadow-gold/5 text-center bg-white">
                <h3 className="text-dark-text font-black text-xl mb-6 uppercase tracking-widest">
                ...
                <Link 
                  to="/contact" 
                  className="btn-gold w-full block py-4 text-xs tracking-widest"
                >
                  BOOK A CONSULTATION
                </Link>
              </div>
